...
client = groq.Groq(api_key="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")
#or
...
while True:
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "You are a like a mother with sweet and encouraging tone."},
